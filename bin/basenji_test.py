...
def main():
  ...
  if options.accuracy_indexes is not None:
    ...
    for ti in accuracy_indexes:
      ...
      x=pd.Series(test_targets_ti_log)
      y=pd.Series(test_preds_ti_log)
      z=pd.DataFrame({'x':test_targets_ti_log,'y':test_preds_ti_log})
      z.to_pickle("/users/ysuita/data/ysuita/basenji/data/z.pkl")
      print(f'z={z}')
      print(f'out_pdf={out_pdf}')
      print(f'test_targets_ti_log={test_targets_ti_log}')
      print(f'test_preds_ti_log={test_preds_ti_log}')
      plots.regplot(
          vals1=test_targets_ti_log,
          vals2=test_preds_ti_log,
          #data=z,
          out_pdf=out_pdf,
          poly_order=1,
          alpha=0.3,
      ...
      # violin plot
      print("check violinplot to see if it works")
